...
namespace RealmOne.Items.Misc.EnemyDrops
{
    public class EnchantedStarglitter : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            ItemGlowy.AddItemGlowMask(Item.type, "RealmOne/Items/Misc/EnemyDrops/EnchantedStarglitter_Glow");
        ...
        {
            Texture2D texture = Request<Texture2D>("RealmOne/Items/Misc/EnemyDrops/EnchantedStarglitter_Glow", AssetRequestMode.ImmediateLoad).Value;
            spriteBatch.Draw
            (
                texture,
                new Vector2
