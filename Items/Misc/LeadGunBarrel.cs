...
{
    public class LeadGunBarrel : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Lead Gun Barrel"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
