...
namespace RealmOne.Items.BossBags
{
    public class OutcropBossBag : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ItemID.Wood, 1, 40, 60));
            itemLoot.Add(ItemDropRule.Common(ItemID.StaffofRegrowth, 10, 1, 1));

            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<TheOutcastsOverseer>(), 3, 1, 1));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<EarthEmerald>(), 4, 1, 1));
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Overgrowth>(), 3, 1, 1));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<GoopyGrass>(), 1, 10, 14));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<FlorenceMarble>(), 3, 10, 16));
