...
namespace RealmOne.Items.BossBags
{
    ...
    //      public override int BossBagNPC => ModContent.NPCType<MegaSquirmHead>();
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ItemID.Worm, 1, 8, 10));
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<TwinklingTwig>(), 3, 1, 1));
            itemLoot.Add(ItemDropRule.MasterModeCommonDrop(ModContent.ItemType<SquirmoRelicItem>()));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<SquirmScarf>(), 1, 1, 1));
