...
namespace RealmOne.Items.Weapons.Demolitionist
{
    public class CopperFragGrenade : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            line = new TooltipLine(Mod, "CopperFragGrenade", "Demolition Stats:")
            {
            ...
            line = new TooltipLine(Mod, "CopperFragGrenade", "Type: Frag Grenade")
            {
            ...
            line = new TooltipLine(Mod, "CopperFragGrenade", "Explosion Radius: 10")
            {
            ...
            line = new TooltipLine(Mod, "CopperFragGrenade", "Destroys Tiles: No")
            {
            ...
            line = new TooltipLine(Mod, "CopperFragGrenade", "Functionality: Weak")
            {
