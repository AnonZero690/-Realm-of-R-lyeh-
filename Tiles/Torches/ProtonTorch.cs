...
using RealmOne.Items.Placeables.Torches;
...
namespace RealmOne.Tiles.Torches
{
	public class ProtonTorch : ModTile
	{
		...
		//	ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<ProtonTorchItem>();
