...
namespace RealmOne.NPCs.Critters
{
    public class IcerockSnail : ModNPC
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo) => spawnInfo.SpawnTileY < Main.worldSurface && Main.dayTime && spawnInfo.Player.ZoneSnow && !Main.dayTime && !spawnInfo.PlayerSafe ? 1f : 0f;
